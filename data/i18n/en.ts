...
export const en = {
  ...
  home: {
    hero: {
      title: "Esther.",
      headline: "Working with AI.",
      thesis: "Business Analyst · Technical PM",
      productLines: [],
      proof: "",
      builderLines: [],
      primaryCta: {
    ...
    aboutShort: {
      title: "Esther",
      paragraphs: [
        "BA / PM who codes. Focused on business process design, data governance, and AI workflow implementation.",
      ],
      cta: {
        label: "",
        href: null,
    ...
    workWithMe: {
      ...
      intro: "",
      items: [
        "→ Business analysis & process modelling (As-Is / To-Be)",
        "→ BI dashboards & data governance",
        "→ AI automation workflow implementation",
        "→ Rapid prototyping & system development (React / Node.js)",
      ],
      closing: "",
      cta: {
        label: "Get in touch",
