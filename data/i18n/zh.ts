...
export const zh = {
  site: {
    ...
    header: {
      ...
      mobileCtaLabel: "联系",
      links: [
        { label: "项目", href: links.lab },
        { label: "关于", href: links.about },
        { label: "联系", href: links.email },
      ],
    },
    footer: {
  ...
  home: {
    ...
    aboutShort: {
      title: "Esther",
      paragraphs: [
        "能写代码的 BA / PM。专注业务流程梳理、数据治理与 AI 工作流落地。",
      ],
      cta: {
        label: "",
        href: null,
    ...
    workWithMe: {
      ...
      intro: "",
      items: [
        "→ 业务梳理与流程建模 (As-Is / To-Be)",
        "→ 数据看板与 BI 治理",
        "→ AI 自动化工作流落地",
        "→ 极速原型与系统构建 (React / Node.js)",
      ],
      closing: "",
      cta: {
        label: "联系我",
